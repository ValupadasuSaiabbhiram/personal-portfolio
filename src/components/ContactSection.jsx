                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:valupadasusaiabbhiram@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                        valupadasusaiabbhiram@gmail.com
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+919849786297" className="text-muted-foreground hover:text-primary transition-colors">
                                        +91 9849786297
                                    </a>
                                </div>
                            </div>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input type="text" id='name' name="name" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary"
                                    placeholder="Sai abbhiram valupadasu...." />
                            </div>
